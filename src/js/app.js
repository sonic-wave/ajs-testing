export default class Validator {
    ...
    checkBankName(ccn) {
        ...
        if ((ccnTwoDigits >= 51 && ccnTwoDigits <= 55) || (ccnFourDigits >= 2211 && ccnFourDigits <= 2720)) {
            this.card.forEach(element => element.classList.add('cardTurnGrey'));
        ...
        if (ccnTwoDigits === 65 || ccnFourDigits === 6011 || (ccnThreeDigits >= 644 && ccnThreeDigits <= 649)) {
            this.card.forEach(element => element.classList.add('cardTurnGrey'));
        ...
        if (ccnTwoDigits === 36 || ccnTwoDigits === 38 || ccnTwoDigits === 39 || (ccnThreeDigits >= 300 && ccnThreeDigits <= 305)) {
            this.card.forEach(element => element.classList.add('cardTurnGrey'));
